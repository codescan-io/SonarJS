...
public class CacheStrategyImpl implements CacheStrategy {
  ...
  static CacheStrategyImpl noCache() {
    return new CacheStrategyImpl(NO_CACHE, null, null);
  }

  static CacheStrategyImpl writeOnly(CacheAnalysisSerialization serialization) {
    return new CacheStrategyImpl(WRITE_ONLY, null, serialization);
  }

  static CacheStrategyImpl readAndWrite(
    CacheAnalysis cacheAnalysis,
    CacheAnalysisSerialization serialization
  ) {
    return new CacheStrategyImpl(READ_AND_WRITE, cacheAnalysis, serialization);
  }
