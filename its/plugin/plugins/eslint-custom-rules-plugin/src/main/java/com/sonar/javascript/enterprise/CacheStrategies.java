...
import static com.sonar.javascript.enterprise.CacheStrategyImpl.noCache;
import static com.sonar.javascript.enterprise.CacheStrategyImpl.readAndWrite;
import static com.sonar.javascript.enterprise.CacheStrategyImpl.writeOnly;
...
public class CacheStrategies implements CacheStrategiesIface {
  ...
  static String getLogMessage(
    CacheStrategyImpl cacheStrategy,
    InputFile inputFile,
  ...
  public CacheStrategy getStrategyFor(SensorContext context, InputFile inputFile)
    throws IOException {
    return getStrategyFor(context, inputFile, PluginInfo.getVersion());
  }

  public CacheStrategy getStrategyFor(
